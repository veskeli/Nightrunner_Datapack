...
execute if score @s[gamemode=!creative] Nightrunner_Mana matches ..4999 run return run function nightrunner:items/tools/staffs/diamond/start_raycast/generated/0
