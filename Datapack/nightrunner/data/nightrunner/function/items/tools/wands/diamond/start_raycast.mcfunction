...
execute if score @s[gamemode=!creative] Nightrunner_Mana matches ..3 run return run function nightrunner:items/tools/wands/diamond/start_raycast/generated/0
# Reduce mana (not in creative mode)
scoreboard players remove @s[gamemode=!creative] Nightrunner_Mana 4
# add cooldown
