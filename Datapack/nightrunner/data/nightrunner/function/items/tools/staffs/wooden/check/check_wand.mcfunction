...
# Offhand item
execute if entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:-106b,components:{"minecraft:custom_data":{wooden_staff:true,wand:true}}}]}] run execute at @s run function nightrunner:items/tools/staffs/wooden/start_raycast
# Reset
