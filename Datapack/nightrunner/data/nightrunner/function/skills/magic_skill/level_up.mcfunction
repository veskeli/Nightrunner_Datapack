...
tellraw @s [{"text":"Magic Skill Leveled Up! ","color":"green","bold":true,"italic":true},{"text":"[Lvl ","color":"yellow"},{"score":{"name":"@s","objective":"Nightrunner_MagicSkillLevel"}},{"text":"]","color":"yellow"}]
