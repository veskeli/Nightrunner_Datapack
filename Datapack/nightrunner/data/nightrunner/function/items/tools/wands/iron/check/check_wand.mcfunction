...
# Selected item
execute if entity @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",components:{"minecraft:custom_data":{iron_wand:true,wand:true}}}}] run execute at @s run function nightrunner:items/tools/wands/iron/start_raycast
# Offhand item
execute if entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:-106b,components:{"minecraft:custom_data":{iron_wand:true,wand:true}}}]}] run execute at @s run function nightrunner:items/tools/wands/iron/start_raycast
# Reset
