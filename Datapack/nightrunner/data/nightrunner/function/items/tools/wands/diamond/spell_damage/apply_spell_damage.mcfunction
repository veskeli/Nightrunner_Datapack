...
execute if score $Nightrunner Nightrunner_Weak_Use matches 1 run return run function nightrunner:items/tools/wands/diamond/spell_damage/apply_spell_damage/generated/2
# Deal damage
