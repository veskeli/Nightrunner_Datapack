...
execute unless score @s[gamemode=!creative] Nightrunner_Mana matches ..1 run execute at @s run playsound minecraft:entity.illusioner.prepare_mirror master @a ~ ~ ~ 0.3 2
# Add damage to item
function nightrunner:items/tools/wands/golden/start_raycast/generated/0
execute as @s[gamemode=!creative] run function nightrunner:items/tools/wands/golden/start_raycast/generated/0
...
function nightrunner:items/tools/wands/golden/start_raycast/generated/1
# add cooldown
