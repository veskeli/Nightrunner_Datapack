...
# Add damage to item
function nightrunner:items/tools/wands/diamond/start_raycast/generated/0
execute as @s[gamemode=!creative] run function nightrunner:items/tools/wands/diamond/start_raycast/generated/0
...
function nightrunner:items/tools/wands/diamond/start_raycast/generated/1
# add cooldown
...
execute anchored eyes positioned ^ ^ ^ store result score @s Nightrunner_Item_Ray_Return run function nightrunner:items/tools/wands/diamond/raycast
