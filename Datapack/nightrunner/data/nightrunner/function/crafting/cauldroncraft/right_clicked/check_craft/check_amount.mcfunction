...
execute if score @s Nightrunner_CauldronCraftableAmountInHand matches ..15 run function nightrunner:crafting/cauldroncraft/right_clicked/check_craft/check_amount/generated/4