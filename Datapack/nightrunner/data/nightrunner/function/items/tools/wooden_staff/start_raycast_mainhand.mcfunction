...
execute anchored eyes positioned ^ ^ ^ store result score @s Nightrunner_Item_Ray_Return run function nightrunner:items/tools/wooden_staff/raycast_mainhand
tag @s remove raycasting
function nightrunner:items/tools/wooden_staff/check_unbreaking
