...
execute if score @s[gamemode=!creative] Nightrunner_Mana matches ..3 run return run function nightrunner:items/tools/wands/wooden/start_raycast/generated/0
