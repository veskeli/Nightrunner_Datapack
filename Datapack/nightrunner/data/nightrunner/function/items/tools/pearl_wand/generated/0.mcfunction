...
execute at @s run execute if score @a[tag=teleporting,gamemode=survival,limit=1,sort=nearest] Nightrunner_Mana matches 5.. run tp @a[tag=teleporting,limit=1,sort=nearest] ~ ~-1 ~0.5
