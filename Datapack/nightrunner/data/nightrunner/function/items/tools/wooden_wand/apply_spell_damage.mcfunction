...
execute if entity @s[nbt={Health:0.0f}] run execute as @a[limit=1,tag=raycasting,sort=nearest] run function nightrunner:items/tools/wooden_wand/apply_spell_damage/entity_died_from_damage
