...
execute if entity @s[type=minecraft:iron_golem] run return run function nightrunner:items/tools/wands/wooden/spell_damage/apply_spell_damage/generated/2
