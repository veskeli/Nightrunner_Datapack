...
# If hit block
execute unless block ~ ~ ~ #nightrunner:air run function nightrunner:items/tools/wands/stone/raycast/generated/0
...
execute if score $Nightrunner Nightrunner_Item_Ray_steps >= $Nightrunner Nightrunner_RangedSpellRange run function nightrunner:items/tools/wands/stone/raycast/generated/1
