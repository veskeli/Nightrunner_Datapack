...
execute unless block ~ ~ ~ #nightrunner:air run function nightrunner:items/tools/pearl_wand/hit_block
...
execute if score $Nightrunner Nightrunner_Item_Ray_steps matches -1 run function nightrunner:items/tools/pearl_wand/hit_block
...
execute if entity @a[sort=nearest,limit=1,tag=raycasting,distance=1..] run function nightrunner:items/tools/pearl_wand/effect
scoreboard players remove $Nightrunner Nightrunner_Item_Ray_steps 1
execute positioned ^ ^ ^0.25 rotated ~ ~ run function nightrunner:items/tools/pearl_wand/raycast_mainhand