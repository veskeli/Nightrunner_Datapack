...
execute at @s run playsound minecraft:entity.illusioner.prepare_mirror master @a ~ ~ ~ 0.3 2
# Add damage to item
function nightrunner:items/tools/staffs/wooden/start_raycast/generated/0
execute as @s[gamemode=!creative] run function nightrunner:items/tools/staffs/wooden/start_raycast/generated/0
