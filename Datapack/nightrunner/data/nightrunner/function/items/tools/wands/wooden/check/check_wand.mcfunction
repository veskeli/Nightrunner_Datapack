...
# Offhand item
execute if entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:-106b,components:{"minecraft:custom_data":{wooden_wand:true,wand:true}}}]}] run function nightrunner:items/tools/wands/wooden/use_secondary
# Reset
