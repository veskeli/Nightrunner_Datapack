...
execute if score @s Nightrunner_CheckCurrentAbsorptionAmount matches 4.. run return 1
...
execute if score @s Nightrunner_CheckCurrentAbsorptionAmount matches 4.. run scoreboard players set @s Nightrunner_CheckCurrentAbsorptionAmount 4
