...
execute anchored eyes positioned ^ ^ ^ store result score @s Nightrunner_Item_Ray_Return run function nightrunner:items/tools/stone_wand/raycast_mainhand
tag @s remove raycasting
function nightrunner:items/tools/stone_wand/check_unbreaking
function nightrunner:items/tools/stone_wand/check_mana
