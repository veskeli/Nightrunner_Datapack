...
execute anchored eyes positioned ^ ^ ^ store result score @s Nightrunner_Item_Ray_Return run function nightrunner:items/tools/boulder_wand/raycast_mainhand
tag @s remove raycasting
function nightrunner:items/tools/boulder_wand/check_unbreaking
