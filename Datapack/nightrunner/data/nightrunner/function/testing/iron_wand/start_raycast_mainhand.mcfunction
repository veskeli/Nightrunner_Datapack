...
execute if score @s[gamemode=!creative] Nightrunner_Mana matches ..0 run return run tellraw @s [{"text":"Not enough mana!","color":"red"}]
...
execute anchored eyes positioned ^ ^ ^ store result score @s Nightrunner_Item_Ray_Return run function nightrunner:testing/iron_wand/raycast_mainhand
tag @s remove raycasting
function nightrunner:testing/iron_wand/check_unbreaking
function nightrunner:testing/iron_wand/check_mana_efficiency
