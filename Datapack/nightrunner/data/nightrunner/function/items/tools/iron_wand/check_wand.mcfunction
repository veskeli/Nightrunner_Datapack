...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",components:{"minecraft:custom_data":{iron_wand:true,wand:true}}}}] run execute at @s run function nightrunner:items/tools/iron_wand/start_raycast_mainhand
