...
execute anchored eyes positioned ^ ^ ^ store result score @s Nightrunner_Item_Ray_Return run function nightrunner:items/tools/diamond_staff/raycast_mainhand
tag @s remove raycasting
function nightrunner:items/tools/diamond_staff/check_unbreaking
