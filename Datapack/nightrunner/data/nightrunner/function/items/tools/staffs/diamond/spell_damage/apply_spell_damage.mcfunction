...
execute if score $Nightrunner Nightrunner_Weak_Use matches 1 run return run function nightrunner:items/tools/staffs/diamond/spell_damage/apply_spell_damage/generated/3
# Deal damage
