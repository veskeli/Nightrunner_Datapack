...
execute anchored eyes positioned ^ ^ ^ store result score @s Nightrunner_Item_Ray_Return run function nightrunner:testing/stone_wand/raycast_mainhand
tag @s remove raycasting
function nightrunner:testing/stone_wand/check_unbreaking
function nightrunner:testing/stone_wand/check_mana_efficiency
